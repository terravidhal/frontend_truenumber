...
import { registerSchema, RegisterFormData, authErrorMessages } from '@/lib/validations/auth-schemas'
  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    try {
      ...
      if (error.response?.status === 409) {
        setError(authErrorMessages.userExists)
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="space-y-1">
        ...
        <CardDescription>
          Entrez vos informations pour créer votre compte TrueNumber
        </CardDescription>
      </CardHeader>
      <CardContent>
